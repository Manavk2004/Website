...
function Projects() {
  return (
    <div className='bg-[#1a1823]/97 h-fit w-full grid grid-cols-13 auto-rows p-4'>
      <ProjectCard title="AI SaaS " description="AI Powered Customer Support Application " class="border-0! col-start-6 col-end-9 row-start-2 row-end-7" image="/nimbus.png"/>
