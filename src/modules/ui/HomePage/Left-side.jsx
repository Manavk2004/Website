...
function LeftSide() {
  return (
    <div className='text-white flex flex-col flex-1 gap-10'>
      ...
      <Button className='bg-[#e0ddef]! text-black/40! w-xs hover:bg-[#e0ddef]/90! hover:text-black/80! hover:scale-105! transform transition-all duration-1000 ease-in-out border-0!'>
        Contact Me
      </Button>
    </div>
  )
